...
class Movies extends Component {
    ...
    render() { 
        ...
        return (  
            ...
            <h3><i>Showing {count} movies from database</i> <i className="fa fa-database"></i></h3>
            <table className="table">
             ...
             <Pagination itemsCount={filtered.} pageSize={pageSize} onPageChange={this.handlePageChange} currentPage={currentPage} />
